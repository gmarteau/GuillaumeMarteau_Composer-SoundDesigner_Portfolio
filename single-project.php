                        ...
                        <?php if ($domains) : ?>
                            <?php foreach ($domains as $domain) : ?>
                                <li class="project__description__text__taxs__item">
                                    <a href="<?= get_term_link($domain->term_id); ?>" class="link--upper"><?= strtoupper($domain->name) ?></a>
                                </li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        <?php if ($skills) : ?>
                            <?php foreach ($skills as $skill) : ?>
                                <li class="project__description__text__taxs__item">
                                    <a href="<?= get_term_link($skill->term_id); ?>" class="link--upper"><?= strtoupper($skill->name) ?></a>
                                </li>
                            <?php endforeach; ?>
                        <?php endif; ?>
                    </ul>
