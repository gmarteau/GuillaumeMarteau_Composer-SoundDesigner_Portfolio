...
<?php while (have_posts()) : the_post() ?>
    <div class="home__title">
        ...
        <h1 class="title title--big">Guillaume Marteau</h1>
    </div>
    ...
    <div class="home__services">
        ...
        <ul class="home__services__list">
            <li class="service service--1">
                <h2 class="service__title"><a class="link" href="<?= get_post_type_archive_link('project') . '?skill=composition' ?>">de la musique à l'image</a></h2>
            ...
            <li class="service service--2">
                <h2 class="service__title"><a class="link" href="<?= get_post_type_archive_link('project') . '?skill=sound-design' ?>">du sound design</a></h2>
                <p class="service__description">
            ...
            <li class="service service--3">
                <h2 class="service__title"><a class="link" href="<?= get_post_type_archive_link('project') . '?skill=integration' ?>">de l'intégration sonore</a></h2>
                <p class="service__description">
